...
public class Service implements IService {
    ...
    public Service(IClasseRepository classeRepository, IProfesseurRepository professeursRepository,
            IEtudiantRepository etudiantsRepository, IUsersAdminRepository usersAdminRepository) {
    ...
    public Utilisateurs insertEtudiant(Etudiant etudiant) {
        return etudiantsRepository.ajouterEtudiant(etudiant);
    }
